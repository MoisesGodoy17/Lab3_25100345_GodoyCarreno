...
public class Main {
    public static void main(String[] args) {
        ...
        Tda_Pixel_GodoyCarreno_25100345 P2 = new Tda_PixBit_GodoyCarreno_25100345(0, 1, 180, 2);
        Tda_Pixel_GodoyCarreno_25100345 P3 = new Tda_PixBit_GodoyCarreno_25100345(1, 0, 270, 3);
        Tda_Pixel_GodoyCarreno_25100345 P4 = new Tda_PixBit_GodoyCarreno_25100345(1, 1, 360, 4);
        ...
        myImage.rotate90(myImage.getLargo(), myImage.getAncho(), 0, myImage.getLargo()-1);
        System.out.println(myImage);
    }
}